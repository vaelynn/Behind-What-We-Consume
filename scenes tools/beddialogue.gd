...
@onready var alex_dialogue = $"../AlexDialogue"   # <-- IMPORTANT: Adjust this path!
...
func _on_body_entered(body):
	...
	# Only allow dialogue if Alex's cond is true
	if alex_dialogue.cond == false:
		print("Cannot start dialogue yet — AlexDialogue not completed.")
		return
